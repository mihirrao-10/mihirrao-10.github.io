...
- Staged whitespace inspection additionally flags upstream formatting inside generated Three.js shader strings. Authored files pass; generated bytes are kept unchanged to preserve the verified build. This is a formatting observation, not a runtime or build failure.
