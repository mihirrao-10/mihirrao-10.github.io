...
The source has **20,480 vertices and 40,960 triangles**. Its mostly pearl `#FAFAFF` surface carries faint lavender `#E8E2F7`, ice blue `#DDEEF9` and a small peach `#FFE4D4` glint. These authored presentation colors have no scientific data meaning. The renderer uses 0.52 face alpha, brighter tessellation edges and sparse moving facet glints. Its shared depth pass preserves the nearest surface without confusing layers of rear faces. No downloaded mesh or implementation is included.
